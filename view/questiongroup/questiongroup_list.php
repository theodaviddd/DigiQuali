...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $searchAll && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/digiquali/view/question_group/question_group_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digiquali/view/question_group/question_group_card.php', 1).'?action=create', '', $permissiontoadd);
